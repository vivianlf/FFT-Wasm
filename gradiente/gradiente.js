...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_gradiente_descendente')) {
        Object.defineProperty(Module['ready'], '_gradiente_descendente', { configurable: true, get: function() { abort('You are getting _gradiente_descendente on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_gradiente_descendente', { configurable: true, set: function() { abort('You are setting _gradiente_descendente on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _gradiente_descendente = Module["_gradiente_descendente"] = createExportWrapper("gradiente_descendente");
