...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fft')) {
        Object.defineProperty(Module['ready'], '_fft', { configurable: true, get: function() { abort('You are getting _fft on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fft', { configurable: true, set: function() { abort('You are setting _fft on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _fft = Module["_fft"] = createExportWrapper("fft");
